...
//	double Angle4=29*RAD;
	...
	static const UINT ElementsCing1[NANIM]={
481	,
479	,
436	,
435	,
...
483	
	...
	static const UINT ElementsCing2[NANIM]={
		417	,
415	,
372	,
371	,
...
419	
	...
	static const UINT ElementsCing3[NANIM]={
		353	,
351	,
308	,
307	,
...
static const UINT ElementsCing4[NANIM]={
289	,
287	,
244	,
243	,
...
static const UINT ElementsCing5[NANIM]={
	225	,
223	,
180	,
179	,
...
static const UINT ElementsCing6[NANIM]={
	161	,
159	,
116	,
115	,
...
static const UINT ElementsCing7[NANIM]={
	97	,
95	,
563	,
562	,
...
static const UINT ElementsCing8[NANIM]={
	544	,
542	,
499	,
498	,
...
ElementsCing[i][7]=ElementsCing8[i];
	...
	static const double Beginnings[NANIM]={
0	,
0.014320309	,
0.028640619	,
0.042960928	,
...
//Speed=0.833;
char spd[] = "Speed";
oapiReadItem_float(cfg,spd,Speed);
LengthCrawl=34.915447;
rt=6371010;
earth_circ=rt*2*PI;
each_deg=earth_circ/360; 
//AngSpeed=1.5*RAD; //rotation speed, 1.5 deg/s
char angspd[] = "AngSpeed";
oapiReadItem_float(cfg,angspd,AngSpeed);
AngSpeed*=RAD;
//TangentSpd=0.544363;
...
char pdmsh[] = "PAD_MESH";
oapiReadItem_string(cfg,pdmsh,PadMesh);
for(UINT i=0;i<256;i++)
{PadModule[i]='\0';}
wCustomPadModule=FALSE;
char pdmdl[] = "PAD_MODULE";
oapiReadItem_string(cfg,pdmdl,PadModule);
if(PadModule[0]!='\0')
{
...
{	
	...
	char scnsts[] = "STATUS";
	char scnlnddearth[] = "Landed Earth";
	char scnhdng[] = "HEADING";
	char scnpos[] = "POS";
	...
	if(oapiGetOrbiterVersion()<160903)
		...
		oapiWriteScenario_string(fh, scnsts, scnlnddearth);
		oapiWriteScenario_float(fh,scnhdng,vs2.surf_hdg*DEG);
		char position[256];
		sprintf(position,"%.20f %.20f",vs2.surf_lng*DEG,vs2.surf_lat*DEG);
		oapiWriteScenario_string(fh,scnpos,position);
	...
	if(oapiGetOrbiterVersion()<160903)
		{
		FILEHANDLE fh=oapiOpenFile("\\Multistage2015\\__Crawl",FILE_OUT,CONFIG);
		oapiWriteScenario_string(fh,scnpos,scnlnddearth);
		oapiWriteScenario_float(fh,scnhdng,vs2.surf_hdg*DEG);
		char position[256];
		sprintf(position,"%.20f %.20f",vs2.surf_lng*DEG,vs2.surf_lat*DEG);
		oapiWriteScenario_string(fh,scnpos,position);
