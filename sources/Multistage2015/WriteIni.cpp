...
void WriteIni::SetFilename(const char *fn)
{
	strcpy_s(filename, MAXLEN, fn);
}
...
void WriteIni::SetCurrentSection(const char *Section)
{
	strcpy_s(sectiontxt, MAXLEN, Section);
}
